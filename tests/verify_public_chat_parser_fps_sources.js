...
requireText(ui, 'P3.generation = "1.5.2-phase12b"', "Phase 12B owner");
...
requireText(ui, "local function p3_upsert_canonical", "canonical indexed owner");
...
for (const forbidden of [
  "p3_resolve", "p3_parse", "TestParse", "p3_enqueue", "p3_process",
...
if (apply.includes("p3_hook_custom_chat_frames")) {
  throw new Error("Phase 12B still installs AddMessage wrappers");
}
