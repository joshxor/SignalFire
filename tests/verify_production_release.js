...
if (tocFiles.length !== luaFiles.length || new Set(tocFiles).size !== tocFiles.length) {
  throw new Error(`TOC production file set is invalid: ${tocFiles.length} entries, ${luaFiles.length} Lua files`);
}
