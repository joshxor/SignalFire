...
assert(SignalFire_VERSION == "1.5.1", "global version is not 1.5.1")
assert(SignalFire_RELEASE_CHANNEL == "stable", "release channel is not stable")
assert(SignalFire_RELEASE_NAME == "SignalFire 1.5.1", "release name is inconsistent")
assert(SignalFire_GetVersion() == "1.5.1", "authoritative version getter is inconsistent")
assert(SignalFire_GetTitleText() == "SignalFire v1.5.1", "production title is inconsistent")
