...
const startMarker = "-- SIGNALFIRE_PHASE2_UI_LIFECYCLE_BEGIN";
const endMarker = "-- SIGNALFIRE_PHASE2_UI_LIFECYCLE_END";
const start = source.indexOf(startMarker);
const end = source.indexOf(endMarker);
if (start < 0 || end < 0 || end <= start) throw new Error("Phase 2 lifecycle markers were not found");
