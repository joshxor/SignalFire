...
local VERSION = SignalFire_VERSION or "1.5.3"
local CHANNEL = "BLFG"
...
function BLFG:CreateUI()
  ...
  local title = font(f, (SignalFire_GetTitleText and SignalFire_GetTitleText()) or "SignalFire v1.5.3", 22, 1, .75, 0)
...
function BLFG:BuildPublicGroups()
  ...
  self.publicSearchLabel = font(p, "Search", 10, .65, .85, 1)
  self.publicSearchLabel:SetPoint("TOPRIGHT", p, "TOPRIGHT", -248, -92)
...
function BLFG:ApplySignalFireBetaTitle()
  ...
  if self.titleText then self.titleText:SetText((SignalFire_GetTitleText and SignalFire_GetTitleText()) or "SignalFire v1.5.3") end
...
VERSION = (SignalFire_GetVersion and SignalFire_GetVersion()) or SignalFire_VERSION or "1.5.3"
